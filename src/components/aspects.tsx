            ...
            <div style={{ margin: "0px 0px 0px 0px" }}>
                {context.aspects.map((aspect, aspectIndex) => (
                    <div key={ aspectIndex } style={Object.values(aspect).toString() == ",,,,,0," ? { display: "none" } : edit ? { margin: "25px 0px 0px 0px" } : { margin: "-15px 0px 35px 0px" }}>
                        ...
                        <p className="header" style={{ fontStyle: "italic", fontWeight: "bold", display: "inline-block" }}>{ aspect.aspect }</p> <p className="paragraph" style={ aspect.flags.length == 0 ? { display: "none", margin: "0px 0px 0px 0px" } : { display: "inline-block", margin: "0px 0px 0px 0px" } }>&#40;{ aspect.flags }&#41;</p>
